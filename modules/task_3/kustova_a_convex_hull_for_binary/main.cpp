...
TEST(Convex_Hull, build_Image_Convex_Hull_Right) {
  ...
  // std::cout << std::endl;
    if (rank == 0) printImage(check, width, height);
// std::cout<<"k"<<std::endl;
    for (int i = 0; i < height; i++) {
...
// TEST(Convex_Hull, build_Image_Convex_Hull_Right_6) {
//     int size, rank;
//     MPI_Comm_rank(MPI_COMM_WORLD, &rank);
//     MPI_Comm_size(MPI_COMM_WORLD, &size);
//     int height = 10;
...
//     image[2][0] = 0; image[2][1] = 1; image[2][2] = 0; image[2][3] = 1; image[2][4] = 0;
//     image[2][5] = 0; image[2][6] = 0; image[2][7] = 0; image[2][8] = 0; image[2][9] = 0;

//     image[3][0] = 0; image[3][1] = 1; image[3][2] = 0; image[3][3] = 1; image[3][4] = 0;
//     image[3][5] = 0; image[3][6] = 0; image[3][7] = 0; image[3][8] = 0; image[3][9] = 0;
...
//     image[6][0] = 0; image[6][1] = 0; image[6][2] = 0; image[6][3] = 0; image[6][4] = 0;
//     image[6][5] = 0; image[6][6] = 0; image[6][7] = 0; image[6][8] = 0; image[6][9] = 0;
...
//     check[1][0] = 0; check[1][1] = 0; check[1][2] = 1; check[1][3] = 0; check[1][4] = 0;
//     check[1][5] = 0; check[1][6] = 0; check[1][7] = 0; check[1][8] = 0; check[1][9] = 0;

//     check[2][0] = 0; check[2][1] = 1; check[2][2] = 1; check[2][3] = 1; check[2][4] = 0;
//     check[2][5] = 0; check[2][6] = 0; check[2][7] = 0; check[2][8] = 0; check[2][9] = 0;

//     check[3][0] = 0; check[3][1] = 1; check[3][2] = 1; check[3][3] = 1; check[3][4] = 0;
//     check[3][5] = 0; check[3][6] = 0; check[3][7] = 0; check[3][8] = 0; check[3][9] = 0;

//     check[4][0] = 0; check[4][1] = 0; check[4][2] = 1; check[4][3] = 0; check[4][4] = 0;
//     check[4][5] = 0; check[4][6] = 0; check[4][7] = 0; check[4][8] = 0; check[4][9] = 0;

//     check[5][0] = 0; check[5][1] = 0; check[5][2] = 0; check[5][3] = 0; check[5][4] = 0;
//     check[5][5] = 0; check[5][6] = 0; check[5][7] = 0; check[5][8] = 0; check[5][9] = 0;

//     check[6][0] = 0; check[6][1] = 0; check[6][2] = 0; check[6][3] = 0; check[6][4] = 0;
//     check[6][5] = 0; check[6][6] = 0; check[6][7] = 0; check[6][8] = 0; check[6][9] = 0;
