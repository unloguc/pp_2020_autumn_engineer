...
//    }
//
//    std::vector<int> buf(imageSize, 0);
//    if (rank == 0) {
//        buf = imageData;
//        buf.resize(delta + rem);
//    } else {
//        if (delta > 0) {
//            buf.resize(delta);
//            MPI_Status status;
//            MPI_Recv(&buf[0], delta, MPI_INT, 0, 0, MPI_COMM_WORLD, &status);
//        }
//    }
//
...
//    }
//
//    std::vector<int> verySuperNewImage(imageSize, 0);
//    std::vector<int> result(imageSize, 0);
//    if (delta > 0 || rank == 0) {
//        //result = contrastRaiseSeq(buf, delta, contrast);
//        result = contrastRaiseSeq(buf, delta, contrast);
//    }
//    MPI_Gatherv(&result[0], delta, MPI_INT, &verySuperNewImage[0], recvcounts, displs,
//        MPI_INT, 0, MPI_COMM_WORLD);
//    return verySuperNewImage;
//
//}
